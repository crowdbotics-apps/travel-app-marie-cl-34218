...
## Project Structure
    ...
    ├── travel_app_marie_cl_34218  # Django project configurations
...
1. Clone this repo and `cd travel_app_marie_cl_34218`
...
2. Clone this repo and `cd travel_app_marie_cl_34218`
